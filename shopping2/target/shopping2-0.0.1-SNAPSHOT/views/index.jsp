...
<head>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" href=" <c:url value='/views/assets/images/logo/favicon.png'/> " type="image/x-icon">
            ...
            <div class="row">
                <div class="col-md-6 align-self-center">
                    <div class="welcome-img">
                        <img src="<c:url value='/views/assets/images/welcome-bg.png' /> " class="img-fluid" alt="">
                    </div>
                </div>
                <div class="col-md-6 align-self-center">
            ...
            <div class="row">
                <div class="col-md-5">
                    <div class="section-top">
                        <h3><span class="style-change">we serve</span>
                            <br>delicious food</h3>
                        <p class="pt-3">They're fill divide i their yielding our after have him fish on there for greater man moveth,
                            moved Won't together isn't for fly divide mids fish firmament on net.</p>
                    </div>
                </div>
            </div>

            <div class="row">
                <c:forEach var="dto" items="${listPro}">
                <div class="col-md-4 col-sm-6">
                    <div class="single-food mt-sm-0">
                        <div class="food-img">
                            <a href="/detail/${dto.id}"><img src="<c:url value='${dto.image}'/>" class="img-fluid" alt=""></a>
                        </div>
                        <div class="food-content">
                            <div class="d-flex justify-content-between">
                                <h5>${dto.name}</h5>
                                <span class="style-change">$ ${dto.price}</span>
                            </div>
                            <p class="pt-3">Face together given move divided form Of Seasons that fruitful.</p><br/>
                            <input type="hidden" id="proId" value="${dto.id}" />
                            <a class="btn btn-warning" onclick="clickAddCart('${dto.id}')">Add to cart</a>
                        </div>
                    </div>
                </div>
                </c:forEach>
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></span>
    ...
    <!-- Footer Area End -->
    <%@include file="fragment/javascript.jsp"%>
    <script type="text/javascript">

        function clickAddCart(proId) {
                var data = {
                    'productId' : proId
                };
                $.ajax({
